<template>
  <div class="transactiondetail">
    ...
    width="200"
    trigger="hover"
    :content="transactionlist[0].to_address2">
    <el-button slot="reference" @click="visible = !visible">更多</el-button>
  </el-popover> -->
        ...
        .then((res) => {
          ...
          if (
            ...
            if (this.transactionlist[0].to_address.length > 6) {
              ...
              this.transactionlist[0].to_address2 = to_address2.toString().replaceAll(",", "");;
              ...
              this.transactionlist[0].amount_detail2 = amount_detail2.toString().replaceAll(",", "");;
              // console.log(this.transactionlist[0].amount_detail2);
              for (let k = 0; k < 6; k++) {
                amount_detail.push(
...
.transactiondetail {
  ...
  .detailcontent {
    ...
    .el-table__header-wrapper {
      background-color: rgba(57, 181, 127, 0.1) !important;
      width: 100%;
      border-radius: 15px;
      color: rgba(57, 181, 127, 1) !important;
    }
    .el-table td,
    .el-table th.is-leaf {
    ...
    .linezong {
      ...
      .line {
        width: 80px;
        height: 2px;
        background-color: rgba(57, 181, 127, 1);
        z-index: 10;
      }
      .line1 {
        position: relative;
